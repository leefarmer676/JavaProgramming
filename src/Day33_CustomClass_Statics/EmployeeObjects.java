...
public class EmployeeObjects {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(employee1.name+ " : " + employee1.salary );//all 3 will print Fady since it's the last name you assigned
        System.out.println(employee2.name+ " : " + employee2.salary );//and there's only one copy of the variable
