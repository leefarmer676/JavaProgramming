...
public class AmazonInc {
    ...
    public static void main(String[] args) {
        ...
        Tester tester2 = new Tester("Rabia", 32, 'F', "QA", 141, 125000, company);

        Tester tester3 = new Tester("Rabia", 32, 'F', "QA", 115, 125000, company);

        Tester tester4 = new Tester("Rabia", 32, 'F', "QA", 415, 125000, company);
